...
printf "========================Running Classification Test====================="
...
| tee results/tf_mobilenetv1_${device}_no_preprocessing_cpu.txt
...
| tee results/tf_resnet101_${device}_no_preprocessing_cpu.txt
